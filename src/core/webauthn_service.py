...
class WebAuthnService:
    def __init__(self, rp_id: str = "localhost", rp_name: str = "Your App"):
        ...
        self.expected_origin = f"https://{rp_id}" if rp_id != "localhost" else "http://localhost:8000"
    
    def generate_registration_options(self, user_id: str, username: str, display_name: str):
    ...
    def verify_registration(self, credential: RegistrationCredential, expected_challenge: str):
    ...
    def verify_authentication(self, credential: AuthenticationCredential, expected_challenge: str, 
