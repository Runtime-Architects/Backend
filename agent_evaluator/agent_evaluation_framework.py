...
# Test case definitions for Carbon Agent
def create_carbon_agent_test_cases() -> List[TestCase]:
    """Create comprehensive test cases for the Carbon Agent"""
    ...
    test_cases = [
        TestCase(
            ...
            expected_behavior=[AgentBehavior.CORRECT_FUNCTION_CALL, AgentBehavior.CONSISTENT_OUTPUT],
        ...
        TestCase(
            ...
            expected_functions=["get_emission_analysis"],
            expected_behavior=[AgentBehavior.CORRECT_FUNCTION_CALL],
        ...
        TestCase(
            ...
            expected_functions=[],  # Should not call emission functions
            expected_behavior=[AgentBehavior.CONSISTENT_OUTPUT],
