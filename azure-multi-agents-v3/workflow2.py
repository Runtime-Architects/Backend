...
### RULES:
- **Always respond in valid JSON format** with the structure:
...
builder.add_edge(planning_agent, reader_agent, condition=is_mentioned("readeragent"))
...
builder.add_edge(reader_agent, report_agent, activation_group="working_agent", activation_condition="any")
...
async def workflow():
    ...
    url= "https://communityenergyhub.ie/wp-content/uploads/2024/04/Electric-Ireland.jpg"
