...
team = SelectorGroupChat(
    [user_proxy, planning_agent, carbon_agent, policy_agent, report_agent],
    model_client=model_client,
...
async def main():
    ...
    task = "Based on last weeks data, What is the best time to use my appliances today in Ireland?"    
