...
2. Identify the region, query only for the region specified. (default to 'all' if not specified)
...
If encountered an error gathering data mention the error to Planneragent. 
Only perfom the tasks you are assigned do not ask follow up questions.
"""
...
**WORKFLOW COMPLETION**: End with "ANALYSIS COMPLETE" when finished, you MUST end with exactly TERMINATE to signal completion.
"""
